...
export const AllOrganizationsMapPage: React.FC = () => {
    ...
    const organizationsArray = organizations?.data
        ?.filter(({ id: organizationsId }) => organizationsIdsArray
            .includes(organizationsId)) ?? organizations.data ?? [];
                    ...
                    <Map
                        ...
                        defaultState={{
                            center: organizationsArray[0]?.latitude
                                ? [organizationsArray[0].latitude, organizationsArray[0].longitude]
                                : ALMETEVSK_CENTER,
                            zoom: 12,
                            controls: []
                        }}
